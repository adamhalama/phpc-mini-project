...
#BSUB -J simulate100v2-1c                       # Job name: simulate20
...
#BSUB -o simulate100v2_1c_%J.out                # Standard output will be saved to a file with the job-id
#BSUB -e simulate100v2_1c_%J.err                # Standard error will be saved to a file with the job-id
