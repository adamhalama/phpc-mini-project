...
#BSUB -J simulate100_cuda                       # Job name: simulate20
...
#BSUB -o simulate100_cuda_%J.out      # Standard output will be saved to a file with the job-id
#BSUB -e simulate100_cuda_%J.err      # Standard error will be saved to a file with the job-id
...
/usr/bin/time -v python simulate_serial_cuda.py 100
