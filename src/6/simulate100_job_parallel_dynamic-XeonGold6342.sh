...
#BSUB -J simulate_parallel_dynamic_chunk-4-24c                       # Job name: simulate20
...
#BSUB -o simulate_parallel_dynamic_chunk-4_24c_%J.out                # Standard output will be saved to a file with the job-id
#BSUB -e simulate_parallel_dynamic_chunk-4_24c_%J.err                # Standard error will be saved to a file with the job-id
...
/usr/bin/time -v python simulate_parallel_dynamic.py 100
